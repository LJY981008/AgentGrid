...
| 2026-06-22 | 백테스트 라이브실용화 — load_range 풀스캔 30초(라이브 21분+ 미완) → DuckDB 단일 컬럼 스토어(578k glob 회피)+momentum 부분 푸시다운(SQL 2점·Python Decimal·bit-identical 6/6). PoC 1.2초. ADR-007·S6-b 선결. critic REVISE 3M 반영(인덱스 EXPLAIN·~770리밸·load_range 동치) | 플랜모드 승인 | [[2026-06-22-백테스트-라이브실용화-DuckDB컬럼스토어]] |

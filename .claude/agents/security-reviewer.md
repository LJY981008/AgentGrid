...
1. **시크릿**: TIINGO_API_KEY·EODHD_API_KEY — 코드·로그·커밋 히스토리·픽스처 노출. `.env` gitignore 확인
2. **공급망**: pip/uv 의존성 취약점 (httpx·pyarrow·duckdb·edgartools 등). Dependabot 보완 수동 검토
